...
-- Function from https://github.com/LunarVim/LunarVim/blob/rolling/lua/lvim/core/cmp.lua
...
M.setup = function()
	...
	cmp.setup({
		...
		mapping = cmp.mapping.preset.insert({
			...
			-- docs window scrolling with CTRL d,f
			["<C-d>"] = cmp.mapping.scroll_docs(-4),
			["<C-f>"] = cmp.mapping.scroll_docs(4),

			-- Tab to next option or snippet insert
			...
			-- Enter to complete or go to next snippet insert
